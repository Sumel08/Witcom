...
import com.upiita.witcom.conference.WitcomProgramActivity;
import com.upiita.witcom.sketch.WitcomSketchActivity;
import com.upiita.witcom.speaker.WitcomSpeakerActivity;
import com.upiita.witcom.tourism.WitcomTourismActivity;
import com.upiita.witcom.workshop.WitcomWorkshopActivity;
import com.viewpagerindicator.IconPagerAdapter;

import static com.upiita.witcom.pager.WitcomBaseActivity.accent;
import static com.upiita.witcom.pager.WitcomBaseActivity.mPager;
import static com.upiita.witcom.pager.WitcomBaseActivity.textWhite;
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if(getArguments().getInt(ARG_SECTION_NUMBER)==1) {
                textView.setText(Html.fromHtml("<font color="+accent+">{ </font><font color="+textWhite+">"+ getContext().getString(R.string.tourism) +"</font><font color="+accent+"> }</font>"));
                imgV.setImageDrawable(getResources().getDrawable(R.drawable.tourism));
            }
            else if(getArguments().getInt(ARG_SECTION_NUMBER)==2) {
                textView.setText(Html.fromHtml("<font color=" + accent + ">{ </font><font color=" + textWhite + ">" + getContext().getString(R.string.speakers) + "</font><font color=" + accent + "> }</font>"));
                imgV.setImageDrawable(getResources().getDrawable(R.drawable.speaker));
            }
            else if(getArguments().getInt(ARG_SECTION_NUMBER)==3) {
                textView.setText(Html.fromHtml("<font color="+accent+">{ </font><font color="+textWhite+">" + getString(R.string.conferences) + "</font><font color="+accent+"> }</font>"));
            ...
            imgV.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(mPager.getCurrentItem() == 0) {
                        //startActivity(new Intent(rootView.getContext(),WitcomTourismActivity.class));
                        ActivityCompat.startActivity(getActivity(), new Intent(rootView.getContext(),WitcomTourismActivity.class), options.toBundle());
                    }
                        ...
                        ActivityCompat.startActivity(getActivity(), new Intent(rootView.getContext(), WitcomWorkshopActivity.class), options.toBundle());
                    }
                                        ...
                                        alertDialogBuilder
                                                ...
                                                .setPositiveButton(getString(R.string.ok), new DialogInterface.OnClickListener() {
                                                    ...
                                                    public void onClick(DialogInterface dialog, int which) {
                                                        ...
                                                        if(rbc.isChecked()) {
                                                            Uri gmmIntentUri = Uri.parse("google.navigation:q=UPIIG");
                                                            ...
                                                            Uri gmmIntentUri = Uri.parse("google.navigation:q=UPIIG&mode=b");
                                                            Intent mapIntent = new Intent(Intent.ACTION_VIEW, gmmIntentUri);
                                                            mapIntent.setPackage("com.google.android.apps.maps");
                                                            startActivity(mapIntent);
                                                            dialog.cancel();
                                                            ...
                                                            Uri gmmIntentUri = Uri.parse("google.navigation:q=UPIIG&mode=w");
                                                            Intent mapIntent = new Intent(Intent.ACTION_VIEW, gmmIntentUri);
                                                            mapIntent.setPackage("com.google.android.apps.maps");
                                                            startActivity(mapIntent);
                                                            dialog.cancel();
                        ...
                        ActivityCompat.startActivity(getActivity(), new Intent(rootView.getContext(),WitcomSketchActivity.class), options.toBundle());
                    }
                }
            });
